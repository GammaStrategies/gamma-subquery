...
// SubQuery native types
class TypedMap<K, V> extends Map<K, V> {}

class BasePool {
  pathIdx: number[];
  path: string[];
  pathStartBlock: number[];
  priority: number;
...
export class BaseTokenDefinition {
  ...
  static zircuit(): TypedMap<string, BasePool> {
    const USDC = "0x3b952c8c9c44e8fe201e2b26f6b2200203214cff";
    const USDT = "0x46dda6a5a559d861c06ec9a95fb395f5c3db0742"; // USDT 6 decimals
    const USDE = "0x5d3a1ff2b6bab83b63cd9ad0787074081a52ef34";
    const WETH = "0x4200000000000000000000000000000000000006";

    const USDC_USDT = "0x23a9191b9492d95e1e511628a7344fc3afc25ad1";
    const USDT_USDE = "0x39500edb530319be3dcba0caf43bd2b5e3a6bb2a";
    const USDC_WETH = "0xaed747772f0cc5026af38569522caa75dcd63d5a";
    ...
    lookup.set(USDT, {
      pathIdx: [0],
      path: [USDC_USDT],
      pathStartBlock: [6168484],
      priority: 3,
    });
    lookup.set(USDE, {
      pathIdx: [0, 0],
      path: [USDT_USDE, USDC_USDT],
      pathStartBlock: [5075945, 6168484],
      priority: 2,
    });
    lookup.set(WETH, {
      pathIdx: [0],
      path: [USDC_WETH],
      pathStartBlock: [6168526],
      priority: 1,
    });
  ...
  static berachain(): TypedMap<string, BasePool> {
    ...
    const BERA = "0x6969696969696969696969696969696969696969";

    const USDCe_HONEY = "0x610d4f0eca45cb04cc576bed0e547139213720e9";
    const WETH_HONEY = "0x9eb897d400f245e151dafd4c81176397d7798c9c";
    const USDCe_BERA = "0x90f79fdec42351e514c35cd93cb5f1b965585132";
  ...
  static sonic(): TypedMap<string, BasePool> {
    ...
    const WAGMI = "0x0e0ce4d450c705f8a0b6dd9d5123e3df2787d16b";

    const USDCe_WETH = "0xfe809a1d337bdfc98b77a1067e3819f66d8ad23f";
    const wS_USDCe = "0x25f746bb206041ed8da6f08ed1d32454a5856d37";
    const USDCe_ANON = "0xb0d458bf56666299ac6ce443c27e39649ac32090";
    const WAGMI_ANON = "0x8f76e0deb376d81fd75028d47de0da7af0a5547e";
  ...
  static bob(): TypedMap<string, BasePool> {
    ...
    const USDT_USDCe = "0x2ece0e4b20ab662a9fc222a391b3ccb9ebf0485d";
    const DAI_USDCe = "0xf1bb28a6f9c4cb93e9a77c9365d1e4ef4c67d493";
    const WETH_USDCe = "0x02f57b2e4d310f3cf432fafa8d0d780ee920467c";
    const WBTC_USDT = "0x6407fec527abad1aafdb9a3b5a2171800c21a2fe";
    const WBTC_solvBTC = "0x508a838922a93096c1eb23fe21d8938bbd653db6";
    ...
    lookup.set(WBTC, {
      pathIdx: [1, 1],
      path: [WBTC_USDT, USDT_USDCe],
      pathStartBlock: [0, 0],
      priority: 2,
    });
    lookup.set(solvBTC, {
      pathIdx: [0, 1, 1],
      path: [WBTC_solvBTC, WBTC_USDT, USDT_USDCe],
      pathStartBlock: [0, 0, 0],
      priority: 1,
    });
  ...
  static unichain(): TypedMap<string, BasePool> {
  ...
  static monadTestnet(): TypedMap<string, BasePool> {
    const USDC = "0xf817257fed379853cde0fa4f97ab987181b1e5ea";
    const ATL = "0x1ea9099e3026e0b3f8dd6fbacaa45f30fce67431";

    const ATL_USDC = "0xe38933dba47d83d3c07f414db2073561e9b49782";
  ...
  static hemi(): TypedMap<string, BasePool> {
    const USDC = "0xad11a8beb98bbf61dbb1aa0f6d6f2ecd87b35afa";
    const VUSD = "0x7a06c4aef988e7925575c50261297a946ad204a8";
    const WETH = "0x4200000000000000000000000000000000000006";
    const hemiBTC = "0xaa40c0c7644e0b2b224509571e10ad20d9c4ef28";

    const VUSD_USDC = "0x0bbd621fb38f6ddc16b0089ebbeade8db9a8d354";
    const WETH_USDC = "0x95a8b611e90de2b682267e2f00c8dff71909298a";
    const VUSD_hemiBTC = "0xc47f921d413787abf5c98d977e52062de0a3a6d4";
  ...
  static nibiru(): TypedMap<string, BasePool> {
    // Token addresses for Nibiru chain (chain ID: 6900)
    const USDC = "0x0829f361a05d993d5ceb035ca6df3446b060970b";  // USDC.e
    const WNIBI = "0x0cacf669f8446beca826913a3c6b96acd4b02a97"; // Wrapped NIBI
    const STNIBI = "0xca0a9fb5fbf692fa12fd13c0a900ec56bb3f0a7b"; // Staked NIBI
    const WETH = "0xcda5b77e2e82265ac25d8d4ef3ca47917693d3d5";  // Wrapped ETH
    
    // Pool addresses (token0 / token1 as specified)
    const USDC_WNIBI = "0xd8f82b8d2e82265ac25d8d4ef3ca47917693d3d5";  // USDC.e / WNIBI
    const USDC_STNIBI = "0x9fe58f1883732931625c281afe2a068fe19183f5"; // USDC.e / stNIBI
    const STNIBI_WETH = "0x9475b76b7f77791b6147cb989187fecd9b55398a"; // stNIBI / WETH
    
    let lookup = new TypedMap<string, BasePool>();
    
    // USDC as base currency (highest priority)
    lookup.set(USDC, {
      pathIdx: [-1],
      path: [ADDRESS_DEAD],
      pathStartBlock: [0],
    ...
    // WNIBI routing through USDC (USDC is token0, WNIBI is token1)
    lookup.set(WNIBI, {
      pathIdx: [0],
      path: [USDC_WNIBI],
      pathStartBlock: [0],
    ...
    // stNIBI routing through USDC (USDC is token0, stNIBI is token1)
    lookup.set(STNIBI, {
      pathIdx: [0],
      path: [USDC_STNIBI],
      pathStartBlock: [0],
    ...
    // WETH routing through stNIBI then USDC (two-hop path)
    // First hop: stNIBI/WETH pool (WETH is token1)
    // Second hop: USDC/stNIBI pool (stNIBI is token1, we want USDC which is token0)
    lookup.set(WETH, {
      pathIdx: [1, 0],
      path: [STNIBI_WETH, USDC_STNIBI],
      pathStartBlock: [0, 0],
      priority: 1,
    });
  ...
  static network(network: string): TypedMap<string, BasePool> {
    ...
    if (network == "mainnet") {
      ...
      mapping = this.unichain();
    } else if (network == "monad-testnet") {
      mapping = this.monadTestnet();
    } else if (network == "hemi") {
      mapping = this.hemi();
    } else if (network == "nibiru") {
      mapping = this.nibiru();
    }
